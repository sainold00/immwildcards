const cards = [
    ...
    {
        name: 'Bianca',
        fullname: 'Bianca Hong',
        title: 'Interactive, UI/UX, Graphic designer',
        content: [
